...
public class PythonXUnitSensorTest {
  ...
  public void shouldSaveCorrectMeasures() {
    DefaultInputFile testFile1 = new DefaultInputFile("moduleKey", "test_sample1.py");
    DefaultInputFile testFile2 = new DefaultInputFile("moduleKey", "tests/dir/test_sample2.py");
    fs.add(testFile1);
    fs.add(testFile2);
  ...
  public void shouldSaveCorrectMeasuresSimpleMode() {
    ...
    fs.add(new DefaultInputFile("moduleKey", "test_sample.py"));
    fs.add(new DefaultInputFile("moduleKey", "tests/dir/test_sample.py"));
    sensor.analyse(project, context);
